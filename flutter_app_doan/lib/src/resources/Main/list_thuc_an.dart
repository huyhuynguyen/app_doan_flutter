...
class ListThucAn extends StatefulWidget {
  String searchText;
  ListThucAn({this.searchText});

  @override
  _ListThucAnState createState() => _ListThucAnState();
}

class _ListThucAnState extends State<ListThucAn> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: listBloc.getListThucAn(this.widget.searchText),
